...
之後每六小時更新一次（北京時間 02:23、08:23、14:23、20:23），GitHub 排程可能延遲。統計小卡最多展示四種語言、兩個編輯器及總時間；不展示專案名稱、檔案路徑、機器名稱或 AI 對話。資料範圍與日期以 WakaTime 回傳結果為準，可在 WakaTime 帳號設定選擇 Asia/Shanghai 時區。
